...
function SyncHumanCollaborationPage() {
    ...
    const { state: { collaborationSession, isLoading, backendVersion, promptCheckpoint } } = useCollaborationExperiment(linkId);
...
export default SyncHumanCollaborationPage