...
import PromptEditor from '../management/prompt-checkpoint/prompt-editor';
import { useParams } from 'react-router-dom';
import PromptEditorContainer from '../management/prompt-checkpoint/prompt-editor-container';
...
export default function PromptEditorPage(){
    ...
    return (
        ...
        <PageContent>
            <FlexStartColumn>
                {promptId && <PromptEditorContainer
                    promptId={promptId}
                />}
            </FlexStartColumn>
        </PageContent>
