...
export default function MinecraftSyncChatGPTPanel({ sessionId, blueprint, minecraftWorldState, minecraftWorldActions, promptCheckpoint, agent, agentConfig, registerAutoExecution, agentIndex, updateFetchResult, logChatGPT, initializedRecordId, postProcess, currentTurn}: MinecraftChatGPTPanelProps) {
